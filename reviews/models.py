...
class Review(models.Model):
    ...
    message = models.TextField(max_length=512, null=True, blank=True, default=None, verbose_name='Отзыв')
...
class ReviewImage(models.Model):
    ...
    is_main = models.BooleanField(default=False, verbose_name='Автарка')
